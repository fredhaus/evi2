        ...
        <div className="container">
                ...
                <div className="table-header results">
                  ...
                  <div className="table-cell header">
                    <img
                      ...
                      alt=""
                      className="step-icon small pdf header"
                    />
                    <h6>Visie</h6>
                  </div>
                  <div className="table-cell header">
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    ...
                    <div
                      ...
                      className="table-cell"
                    >
                      <div className="score-circle pdf">
          ...
          <div className="text-block-wrapper">
                    ...
                    <div className="results-score-wrapper">
                      <div className="results-score-number pdf">
                    ...
                    <div className="content-block">
                      ...
                      <div className="scenario-wrapper-static">
                        ...
                        <div className="form-row-header scenario-header">
                          ...
                          <p>
                            De school onderzoekt met externe partners en deskundigen 
                         hoe de inhoud van het cultuuronderwijs zo optimaal mogelijk 
                         aansluit bij de culturele ontwikkeling van alle leerlingen. 
                         De school legt de afspraken over samenwerking met externe 
                         partners en deskundigen vast. 
                            <br />
                          </p>
                        </div>
                      </div>
