...
class ResultsTab4 extends React.Component {
  ...
  render() {
    return (
      <div datatab="Tab 4" className="tab-pane w-tab-pane w--tab-active">
      <div className="container marginbottom80">
        <div className="intro-text results">
          ...
          <div className="paragraph-light">
            Op welke manier geeft jouw school het culturele
            programma voor de leerlingen vorm en inhoud? Op welke
            manier vullen jullie het programma in?
            <br />
          </div>
        </div>
      </div>
            ...
            <div className="content-block">
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft Programma zit jullie school in
                    scenario 1. Mogelijk willen jullie de culturele
                    activiteiten, lessen of workshops meer op elkaar
                    afstemmen en een stap zetten naar het niveau van
                    scenario 2. In dat geval kunnen jullie de
                  ...
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Maak gebruik van een cultuurmenu dat in de
                        regio wordt aangeboden.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Verken hoe het programma voor
                        cultuuronderwijs meer planmatig via bv
                        projectweken of vaste momenten in de week
                        kan worden ingevuld.
                      </p>
                    </li>
                    <li className="list-item">
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft Programma zit jullie school in
                    scenario 2.&nbsp;Dit is een mooie basis, die
                  ...
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Breng bewuste keuzes aan voor samenhang in
                        je programma, bijvoorbeeld voor
                        vakverbindingen en/of een doorlopende
                        leerlijn.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Formuleer heldere doelen voor
                        cultuuronderwijs, vertaal dit naar het
                        programma en de beschikbare tijd en
                        middelen.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        ...
                        van programma’s cultuuronderwijs bij het
                        icc- en/of cultuurbegleidersnetwerk.&nbsp;
                      </p>
                    </li>
                  </ul>
                  <p>
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft Programma zit jullie school in
                    scenario 3.&nbsp;Jullie weten het programma
                    vanuit bewuste keuzes in samenhang neer te
                    zetten door bijvoorbeeld vakverbinding en/of in
                    een doorlopende leerlijn. Dit is een mooie
                    ...
                    scenario 4. In dat geval kunt je de volgende
                    dingen doen:
                    <br />
                  </p>
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Verken hoe je het programma kunt laten
                        aansluiten met buitenschoolse activiteiten,
                        voorschoolse educatie en het voortgezet
                        onderwijs.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        ...
                        netwerkscholen, bijvoorbeeld een
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft Programma zit je in scenario
                    4Probeer dit niveau vast te houden. Jullie
                    slagen er in om een passend en verdiepend
                    programma cultuuronderwijs op jullie school neer
                    te zetten, afgestemd op zowel de binnen- als
                    buitenschoolse ontwikkelingen. Om scherp en
                    kritisch te blijven, maar ook om je kennis over
                    de invulling van het programma te delen, kunnen
                  ...
                  <ul className="list margin20">
                    ...
                    <li className="list-item">
                      <p>
                        Sluit je aan bij regionale netwerken,
          ...
          >
            ...
            <div className="form-section">
              ...
              <div className="form-row first">
                <div className="form-row-header">
                  <h4>
                    Op welke manier wordt het programma
                    cultuuronderwijs op jullie school ingevuld?
                  </h4>
                </div>
              ...
              <div className="form-row">
                <div className="form-row-header">
                  <h4>
                    Brengen jullie hier bewust samenhang in aan?
                  </h4>
                </div>
                <div className="form-wrapper">
              ...
              <div className="form-row">
                <div className="form-row-header">
                  <h4>
                    ...
                    cultuuronderwijs uitgewerkt en vastgelegd
                    (bijvoorbeeld voor een van de kunstdisciplines)?
                  </h4>
                </div>
                <div className="form-wrapper">
                  <div className="form _2-col-row">
              ...
              <div className="form-row">
                <div className="form-row-header">
                  <h4>
                    Geef een korte omschrijving van de doorgaande
                    leerlijn cultuuronderwijs op jullie school.
                  </h4>
                </div>
                <div className="form-wrapper">
                  <div className="form">
                    <div className="text-field static-text-field">
                      <p>
                        ...
                        lorem imperdiet. Nunc ut sem vitae risus
                        tristique posuere.
                      </p>
                    </div>
                  </div>
              ...
              <div className="form-row">
                <div className="form-row-header">
                  ...
                  <h4>
                    Wat is jullie manier om samenhang aan te brengen
              ...
              <div className="form-row">
                <div className="form-row-header">
                  ...
                  <h4>
                    Waarom wordt niet bewust samenhang aangebracht?
                  </h4>
                </div>
                <div className="form-wrapper">
                  <div className="form">
              ...
              <div className="form-row">
                <div className="form-row-header">
                  <h4>
                    Hoe volgen jullie de ontwikkeling van jullie
                    leerlingen in cultuuronderwijs?
                  </h4>
                </div>
                <div className="form-wrapper">
                  <div className="form">
            ...
            <div className="form-section">
              ...
              <div className="table">
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      ...
                      betekenisgeven aan en reflecteren op zichzelf
                      en de wereld
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Geeft onze leerlingen de ruimte om zelfsturend
                      te zijn en{" "}
                      <em>vanuit hun eigen vraag en interesse</em>{" "}
                      te kunnen werken
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      ...
                      <em>zich verbonden voelen</em> met hun eigen
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Biedt onze leerlingen een zo breed mogelijk
                      palet om{" "}
                      <em>
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Versterkt de taalontwikkeling en sociaal
                      emotionele ontwikkeling bij leerlingen
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Daagt onze leerlingen uit om hun artistiek,
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Biedt ruimte voor artistieke expressie en
                      presentatie
                    </p>
                    <div
            ...
            <div className="form-section">
              ...
              <div className="form-row first">
                <div className="form-row-header">
                  <h4>
                    In hoeverre zijn jullie tevreden over het
                    programma cultuuronderwijs op jullie school?
            ...
            <div className="form-section">
              ...
              <div className="form-row first">
                <div className="form-row-header">
                  <h4>
                    Heeft jullie school de intentie om haar
                    programma voor cultuuronderwijs (inhoud,
                    samenhang en doorlopende leerlijn) verder te
                    ontwikkelen?
                  </h4>
                </div>
                <div className="form-wrapper">
              ...
              <div className="form-row">
                <div className="form-row-header">
                  ...
                  <h4>
                    ...
                    plannen hebben voor verdere ontwikkeling van
                    jullie programma cultuuronderwijs? Licht het
                    antwoord toe.
                  </h4>
                </div>
                <div className="form-wrapper">
                  ...
                  <div className="form">
                    <div className="radio-button-field scenario _1">
                      ...
                      <div className="form-row-header scenario-header">
                        <h4 className="heading">Scenario 1</h4>
                        <p>
                          De culturele activiteiten, lessen of
                          workshops vertonen geen samenhang. Ze
                          vinden incidenteel – zonder structureel
                          budget - plaats en worden willekeurig
                          gekozen.
                          <br />
                        </p>
                      </div>
                    ...
                    <div className="radio-button-field scenario _2">
                      ...
                      <div className="form-row-header scenario-header">
                        ...
                        <p>
                          De culturele activiteiten, lessen of
                          workshops zijn enigszins op elkaar
                          afgestemd, bijvoorbeeld in de vorm van een
                          cultuurmenu of projectweek. Hiervoor
                          worden voldoende tijd en middelen
                          gereserveerd.
                          <br />
                        </p>
                      </div>
                    ...
                    <div className="radio-button-field scenario _3">
                      ...
                      <div className="form-row-header scenario-header">
                        <h4 className="heading">Scenario 3</h4>
                        <p>
                          De school brengt bewust samenhang aan -
                          vanuit de zelf benoemde doelen - in de
                          culturele activiteiten, lessen of
                          workshops door bijvoorbeeld samenhang met
                          andere vakken en/of een opbouw van groep 1
                          t/m 8. Hiervoor wordt structureel
                          voldoende tijd en middelen gezocht en/of
                          gereserveerd.
                          <br />
                        </p>
                      </div>
                    ...
                    <div className="radio-button-field scenario _4">
                      ...
                      <div className="form-row-header scenario-header">
                        ...
                        <p>
                          ...
                          workshops door bijvoorbeeld samenhang met
                          andere vakken en/of een opbouw van groep 1
                          t/m 8. Ook wordt een verbinding gemaakt
                          met buitenschoolse activiteiten, de
                          voorschoolse educatie, of het voortgezet
                          onderwijs. Tijd en middelen zijn
            ...
            <div className="form-section">
              ...
              <div className="form-row first">
                <div className="form-row-header">
                  <h4>
                    Als jullie nog iets kwijt willen over het
                    programma cultuuronderwijs op jullie school, kan
                    dat hier.
                  </h4>
                </div>
                <div className="form-wrapper">
