      ...
      <div className="container marginbottom80">
        <div className="intro-text results">
          ...
          <div className="paragraph-light">
            Waar zou cultuuronderwijs op jouw school aan moeten
            bijdragen? Wat vind je als school belangrijk? En wat wil
            je je leerlingen meegeven?
            <br />
          </div>
        </div>
      </div>
            ...
            <div className="content-block">
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft <em>Visie</em> zit jullie school in
                    scenario 1. Mogelijk willen jullie een stap
                    zetten in het vastleggen van een eigen visie en
                    richting scenario 2 gaan. In dat geval kunnen
                  ...
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Verzamel inzichten in de school en stel
                        samen met iemand die cultuur onder haar
                        hoede krijgt (bv
                        cultuurcontactpersoon/icc’er/leerkracht
                        cultuur) <em>en</em> de directie een visie
                        voor cultuuronderwijs op.&nbsp;
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Leg deze visie vast in een cultuurplan van
                        de school.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Evalueer jaarlijks het cultuuronderwijs op
                        jullie school.
                      </p>
                    </li>
                  </ul>
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Versterk het draagvlak voor cultuuronderwijs
                        door met het hele team de visie te
                        bespreken.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Laat het cultuurplan een apart onderdeel
                        zijn van het schoolplan.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                    ...
                    <li className="list-item">
                      <p>
                        De visie en plannen kunnen een vast
                        onderdeel worden van de jaarlijkse
                        evaluatie.
                      </p>
                    </li>
                  </ul>
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft <em>Visie </em>zit jullie school in
                    scenario 3. Vanuit een breed gedragen visie en
                    een gedegen kwaliteitscyclus weten jullie
                    cultuuronderwijs stevig neer te zetten in jullie
                    school. Mogelijk willen jullie dit behouden,
                    aanscherpen of bestendigen. Een stap zetten naar
                    scenario 4 kan ook een ontwikkelrichting zijn.
                  ...
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Ontwikkel met het hele team een brede visie,
                        met aandacht voor cultuuronderwijs, op
                        onderwijs.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Integreer de visie op cultuuronderwijs in de
                        brede onderwijsvisie van de school en neem
                        dit op in het schoolplan. Betrek, indien
                        wenselijk, je bestuur in deze
                        ontwikkelingen.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Evalueer jaarlijks – met het hele team - de
                        visie en het schoolplan
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft <em>Visie</em> zit je in scenario 4.
                    Probeer dit niveau vast te houden. Om scherp en
                    kritisch te blijven, maar ook om je kennis te
                  ...
                  <ul className="list margin20">
                    ...
                    <li className="list-item">
                      <p>
                        Regelmatig de visie en ontwikkelingen op je
                        school delen en afstemmen met je bestuur en
          ...
          >
            ...
            <div className="form-section">
              ...
              <div className="form-row">
                <div className="form-row-header">
                  <h4>
                    Is deze visie vastgelegd in een beleidsstuk?
                  </h4>
                </div>
                <div className="form-wrapper">
              ...
              <div className="form-row">
                <div className="form-row-header">
                  <h4>
                    Wat willen jullie met het cultuuronderwijs op
                    jullie school bereiken?
                  </h4>
                </div>
                <div className="form-wrapper">
                  <div className="form">
            ...
            <div className="form-section">
              <div className="form-section-header">
                ...
                <div>
                  ...
                  <p>
                    ...
                    wat jullie leerlingen willen meegeven?
                    <br />
                    Wij vinden het belangrijk dat in ons
                    cultuuronderwijs..
                    <br />
                  </p>
                </div>
              ...
              <div className="table">
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Onze leerlingen leren betekenisgeven aan en
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Onze leerlingen <em>zich verbonden voelen</em>{" "}
                      met hun eigen omgeving en achtergrond
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Taalontwikkeling of sociaal-emotionele
                      ontwikkeling wordt versterkt
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Onze leerlingen
                      <em> ambachtelijke vaardigheden</em>{" "}
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Onze leerlingen hun artistiek, creatief en
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Onze leerlingen <em>zich kunnen uiten</em>{" "}
                      door artistieke expressie en dit kunnen
                      presenteren
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Wij onze leerlingen een onderzoekende en open
                      houding meegeven
                    </p>
                    <div
              ...
              <div className="form-row first">
                <div className="form-row-header">
                  <h4>
                    ...
                    cultuuronderwijsvisie van jullie school zoals
                    bij vraag 1.1 ingevuld? Licht de beoordeling
                    toe.
                  </h4>
                </div>
                <div className="form-wrapper">
            ...
            <div className="form-section">
              ...
              <div className="form-row first">
                <div className="form-row-header">
                  <h4>
                    Heeft jullie school de intentie om haar visie en
                    beleid op het gebied van cultuuronderwijs verder
                    te ontwikkelen?
                  </h4>
                </div>
                <div className="form-wrapper">
              ...
              <div className="form-row">
                <div className="form-row-header">
                  ...
                  <h4>
                    ...
                    intentie hebben om jullie visie en/of beleid
                    verder te ontwikkelen? Licht het antwoord toe.
                  </h4>
                </div>
                <div className="form-wrapper">
                  <div className="form">
                  ...
                  <div className="form">
                    ...
                    <div className="radio-button-field scenario _2">
                      ...
                      <div className="form-row-header scenario-header">
                        ...
                        <p>
                          ...
                          cultuuronderwijs vastgelegd in een
                          cultuurplan. De visie wordt gedragen en
                          geëvalueerd door de directeur en iemand
                          met cultuur onder haar hoede (bv
                          cultuurcontactpersoon, icc-er of
                          leerkracht cultuur), zij houden het team
                          op de hoogte en waar mogelijk praat het
                          team mee.
                        </p>
                      </div>
                    </div>
                    <div className="radio-button-field scenario _3">
                      ...
                      <div className="form-row-header scenario-header">
                        ...
                        <p>
                          De school heeft een eigen visie op
                          cultuuronderwijs die als apart onderdeel
                          is opgenomen in een schoolplan. De visie
                          is mede-ontwikkeld door het team en zij
                          beslissen mee.
                        </p>
                      </div>
                    </div>
                    <div className="radio-button-field scenario _4">
                      ...
                      <div className="form-row-header scenario-header">
                        <h4 className="heading">Scenario 4</h4>
                        <p>
                          De school heeft een visie op
                          cultuuronderwijs geïntegreerd in haar
                          bredere onderwijsvisie en opgenomen in het
                          schoolplan. Deze brede visie, met aandacht
                          voor cultuuronderwijs, is ontwikkeld door
                          het team. Het team voelt zich eigenaar van
                          de visie en plannen, deze zijn een vast
                          onderdeel worden van de jaarlijkse
                          evaluatie.
                        </p>
                      </div>
