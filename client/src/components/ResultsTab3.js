...
class ResultsTab3 extends React.Component {
  ...
  render() {
    return (
      <div datatab="Tab 3" className="tab-pane w-tab-pane w--tab-active">
      <div className="container marginbottom80">
        <div className="intro-text results">
          ...
          <div className="paragraph-light">
            ...
            cultuuronderwijs binnen jouw school? Wat hebben jullie
            in huis?
            <br />
          </div>
        </div>
            ...
            <div className="content-block">
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft <em>Deskundigheid </em>zit jullie
                    school in scenario 1. Mogelijk willen jullie
                    meer coördinatie in de deskundigheid aanbrengen
                    en een stap zetten naar het niveau van scenario
                    2. In dat geval kunnen jullie de volgende dingen
                    doen:
                    <br />
                  </p>
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Breng de expertise(s) en gebieden van
                        deskundigheid van je team in kaart.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Breng de mogelijkheid tot scholing op het
                        gebied van kunst- en cultuuronderwijs in
                        kaart, breng dit onder de aandacht bij het
                        team en maak hier een plan voor. Vertrek
                        hierbij vanuit de vraag: wat wil je als
                        school met kunst- en cultuuronderwijs
                        bereiken (visie) en welke deskundigheid is
                        daarvoor nodig? Denk aan een teamscholing,
                        co-teaching, (icc)cursussen, de post-hbo
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft Deskundigheid zit jullie school in
                  ...
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Stel iemand aan die het deskundigheidbeleid
                        gericht stimuleert, coördineert en
                        organiseert.
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Deskundigheid van het team of externen
                        bewust en gericht inzetten in de uitvoering
                        van het programma, aansluitend bij de visie
                        van de school.&nbsp;
                      </p>
                    </li>
                    <li className="list-item">
                  ...
                  <p>
                    ...
                    <em>adviseur</em>? Neem dan via deze knop
                    contact op.Hier vinden jullie een overzicht van
                    het scholingsaanbod en relevante partners bij
                    jullie in de buurt.
                    <br />
                  </p>
                </div>
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft Deskundigheid zit jullie school in
                    scenario 3. Jullie weten de
                    deskundigheidsbevordering binnen het team goed
                    te coördineren en waar mogelijk te
                    bevorderen.&nbsp;Dit is een mooie basis, die
                    jullie misschien willen behouden, aanscherpen of
                    bestendigen. Mogelijk willen jullie een stap
                    zetten naar het niveau van scenario 4. In dat
                    geval kun je de volgende dingen doen:
                    <br />
                  </p>
                  <ul className="list margin20">
                    <li className="list-item">
                      <p>
                        Bevorder het bewust en gericht inzetten van
                        de deskundigheid van het team of externen
                        bij&nbsp; de uitvoering van het programma en
                        aansluitend bij de visie van de
                        school.&nbsp;
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                        Stel een integraal
                        professionaliseringsbeleid op waarin de
                        kwaliteiten van teamleden worden
                        gestimuleerd en ingezet. Bespreek dit
                        jaarlijks. Benut de kwaliteiten van het team
                        of zet vakdocenten/externen in (eventueel
                        ook voor co-teaching).&nbsp;
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
              ...
              <div className="scenario-wrapper-static">
                ...
                <div className="form-row-header scenario-header">
                  ...
                  <p>
                    Wat betreft Deskundigheid zit je in scenario 4.
                    Probeer dit niveau vast te houden. Om scherp en
                    kritisch te blijven, maar ook om je kennis over
                    deskundigheid te delen kunnen jullie de volgende
                    dingen doen:
                    <br />
                  </p>
                  <ul className="list margin20">
                    ...
                    <li className="list-item">
                      <p>
                        ...
                        cultuuronderwijs bij jou in de buurt.
                      </p>
                    </li>
                  </ul>
                  <p>
          ...
          >
            ...
            <div className="form-section">
              ...
              <div className="form-row first">
                <div className="form-row-header">
                  <h4>
                    Welke deskundigheid is in jullie school
                    aanwezig?
                  </h4>
                </div>
            ...
            <div className="form-section">
              <div className="form-section-header">
                ...
                <div>
                  ...
                  <p>
                    ...
                    <br />
                    Voor cultuuronderwijs hebben wij deskundigen in
                    onze school die&nbsp;
                    <br />
                  </p>
                </div>
              ...
              <div className="table">
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Leerlingen stimuleren om betekenis te geven
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Leerlinggestuurd, op basis van de eigen vraag
                      en interesse van de leerling, werken
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      De link kunnen leggen tussen cultuuronderwijs
                      en de omgeving en achtergrond van onze
                      leerlingen
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Leerlingen een zo breed mogelijk palet aan
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Weten hoe via cultuuronderwijs
                      taalontwikkeling en sociaal emotionele
                      ontwikkeling kunnen worden versterkt
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Onze leerlingen{" "}
                      <em>ambachtelijke vaardigheden</em> aanleren
                      in uiteenlopende media (materialen,
                      ICT-middelen, voorwerpen, instrumenten,
                      gesproken en geschreven taal, het (eigen)
                      lichaam)
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Het artistiek, creatief en innovatief vermogen
                      bij leerlingen ontwikkelen en stimuleren
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Onze leerlingen kunnen begeleiden in hun
                      artistieke expressie en de presentatie daarvan
                    </p>
                    <div
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Weten hoe ze cultuuronderwijs kunnen verbinden
                      met andere vakken, leergebieden,
                ...
                <div className="form-block table w-form">
                  ...
                  >
                    <p>
                      Onze leerlingen door cultuuronderwijs
                      stimuleren om met een nieuwsgierige,
                      onderzoekende en open houding in de wereld te
                      staan
                    </p>
                    <div
            ...
            <div className="form-section">
              ...
              <div className="form-row first">
                <div className="form-row-header">
                  <h4>
                    In hoeverre zijn jullie tevreden met de
                    aanwezige deskundigheid voor cultuuronderwijs op
              ...
              <div className="form-row">
                <div className="form-row-header">
                  ...
                  <h4>
                    ...
                    plannen of wensen hebben voor meer
                    deskundigheid? Licht het antwoord toe.
                  </h4>
                </div>
                <div className="form-wrapper">
                  <div className="form">
                  ...
                  <div className="form">
                    <div className="radio-button-field scenario _1">
                      ...
                      <div className="form-row-header scenario-header">
                        ...
                        <p>
                          ...
                          interne deskundigheid niet bewust op het
                          gebied van cultuuronderwijs.
                        </p>
                      </div>
                    </div>
                    <div className="radio-button-field scenario _2">
                      ...
                      <div className="form-row-header scenario-header">
                        <h4 className="heading">Scenario 2</h4>
                        <p>
                          De school coördineert de deskundigheid op
                          het gebied van cultuuronderwijs in haar
                          school wel (bijvoorbeeld door een icc’er),
                          maar stimuleert deze niet. Er is zicht op
                          waar de deskundigheid zit voor
                          cultuuronderwijs.
                          <br />
                        </p>
                      </div>
                    ...
                    <div className="radio-button-field scenario _3">
                      ...
                      <div className="form-row-header scenario-header">
                        ...
                        <p>
                          ...
                          cultuuronderwijs. Er is organisatorische
                          deskundigheid in de school (bijvoorbeeld
                          een icc-er/cultuurbegeleider) die
                          deskundigheid bewust en gericht inzet en
                          bovendien incidentele professionalisering
                          stimuleert, coördineert en organiseert
                          (bijv. teamscholingen). Hiervoor worden
                    ...
                    <div className="radio-button-field scenario _4">
                      ...
                      <div className="form-row-header scenario-header">
                        <h4 className="heading">Scenario 4</h4>
                        <p>
                          De school coördineert en bevordert
                          planmatig en structureel de deskundigheid
                          van het hele team op het gebied van
                          cultuuronderwijs. Kwaliteiten van
                          teamleden worden gestimuleerd en ingezet.
                          De school is, ook op het vlak van
                          cultuuronderwijs, een lerende organisatie
                          hiervoor zijn ruimschoots middelen
                          beschikbaar.
                          <br />
                        </p>
                      </div>
              ...
              <div className="form-row first">
                <div className="form-row-header long">
                  <h4>
                    ...
                    ‘deskundigheid op jullie school, kan dat hier.
                  </h4>
                </div>
                <div className="form-wrapper">
                  <div className="form">
